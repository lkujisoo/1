  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="userlist" stripe border height="420">
        ...
        <el-table-column label="活动详情" prop="content"></el-table-column>
        <el-table-column label="联系电话" prop="tel"></el-table-column>
        <el-table-column label="活动类型" prop='roler' :formatter="formatRole"></el-table-column>
      ...
      <el-dialog title="添加活动" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
        ...
        <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="80px">
          ...
          <el-form-item label="活动类型" prop="role">
            <el-select v-model="addForm.role" placeholder="请选择活动类型">
              <el-option label="室外活动" value="0"></el-option>
              <el-option label="室内活动" value="1"></el-option>
            </el-select>
          </el-form-item>
        </el-form>
        <!-- 底部按钮区 -->
      ...
      >
        ...
        <el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="80px">
          ...
          <el-form-item label="活动类型" prop="">
            <el-select v-model="editForm.roler" placeholder="请选择活动类型">
              <el-option label="室内活动" value="0"></el-option>
              <el-option label="室外活动" value="1"></el-option>
            </el-select>
          </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
  ...
  data() {
    ...
    return {
      ...
      addFormRules: {
        ...
        content: [{ required: true, message: "请选择活动详情", trigger: "blur" }],
        telephone: [
      ...
      editFormRules: {
        ...
        role: [{ required: true, message: "请选择活动类型", trigger: "blur" }]
      },
      // 控制分配角色对话框的显示与隐藏
